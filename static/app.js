class FrequenciaApp {
    constructor() {
        this.baseURL = 'http://127.0.0.1:8002/api/v1';
        ...
        try {
            ...
            relatorioHTML += `
                <div style="margin-top: 1.5rem; display: flex; gap: 0.75rem; justify-content: center;">
                    <button class="btn btn-success" onclick="app.exportarRelatorio()">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
    ...
    exportarRelatorio() {
        this.showAlert('Funcionalidade de exportação em desenvolvimento', 'warning');
    }
}
